    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('clinical_case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='patient_app.casclinique')),
            ],
        ),
        migrations.CreateModel(
            name='Examen',
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('clinical_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.casclinique')),
            ],
        ),
        migrations.CreateModel(
            name='Feedback',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('life_style', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.modevie')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('clinical_case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.casclinique')),
                ('type_parameter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.typeparametre')),
            ],
        ),
        migrations.CreateModel(
            name='Media',
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('exam', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.examen')),
            ],
        ),
        migrations.CreateModel(
            name='Maladie',
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('medical_antecedent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.antecedentmedical')),
                ('treatment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.traitement')),
            ],
        ),
        migrations.CreateModel(
            name='Log',
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('doctor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='patient_app.medecin')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('virtual_case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='patient_app.casvirtuel')),
                ('learner_physician', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='patient_app.medecinapprenant')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('symptom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='patient_app.symptome')),
            ],
        ),
        migrations.CreateModel(
            name='Concept',
