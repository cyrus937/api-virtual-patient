...
routers.register(r'physical-diagnostic', views.DiagnosisPhysicsViewSet)
routers.register(r'exam', views.ExamViewSet)
routers.register(r'physical-exam', views.ExamPhysicsViewSet)
...
routers.register(r'description-symptom', views.DescriptionSymptomViewSet)
